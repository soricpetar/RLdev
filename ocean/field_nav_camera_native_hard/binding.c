...
void my_init(Env* env, Dict* kwargs) {
    ...
    env->front_camera_fov_deg = env_get_float(kwargs, "front_camera_fov_deg", 180.0f);
    env->heading_alignment_scale = env_get_float(kwargs, "heading_alignment_scale", 0.0f);
    env->goal_outside_fov_penalty = env_get_float(kwargs, "goal_outside_fov_penalty", 0.0f);
    ...
    env->speed_control = env_get_int(kwargs, "speed_control", 0);
