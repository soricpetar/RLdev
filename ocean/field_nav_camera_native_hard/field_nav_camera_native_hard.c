...
int main(void) {
    ...
    env.polar_max_distance_m = 16.0f;
    env.front_camera_fov_deg = 180.0f;
    env.heading_alignment_scale = 0.08f;
    env.goal_outside_fov_penalty = 0.02f;
    ...
    env.blocked_corridor_prob = 0.0f;
    env.blocked_corridor_wall_prob = 0.5f;
    env.blocked_corridor_min_distance_m = 6.0f;
    env.blocked_corridor_max_distance_m = 11.0f;
    env.blocked_corridor_min_half_width_m = 2.6f;
    env.blocked_corridor_max_half_width_m = 4.6f;
    env.tree_rows_min = 2;
    env.tree_rows_max = 4;
    env.bushes_min = 6;
    env.bushes_max = 14;
