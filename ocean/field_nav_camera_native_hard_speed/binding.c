#include "../field_nav_camera_native_hard/field_nav.h"
...
void my_init(Env* env, Dict* kwargs) {
    ...
    env->front_camera_fov_deg = env_get_float(kwargs, "front_camera_fov_deg", 100.0f);
    env->heading_alignment_scale = env_get_float(kwargs, "heading_alignment_scale", 0.06f);
    env->goal_outside_fov_penalty = env_get_float(kwargs, "goal_outside_fov_penalty", 0.02f);
    ...
    env->max_speed_mps = env_get_float(kwargs, "max_speed_mps", 1.2f);
    ...
    env->blocked_corridor_prob = env_get_float(kwargs, "blocked_corridor_prob", 0.0f);
    env->blocked_corridor_wall_prob = env_get_float(kwargs, "blocked_corridor_wall_prob", 0.5f);
    env->blocked_corridor_min_distance_m = env_get_float(kwargs, "blocked_corridor_min_distance_m", 6.0f);
    env->blocked_corridor_max_distance_m = env_get_float(kwargs, "blocked_corridor_max_distance_m", 11.0f);
    env->blocked_corridor_min_half_width_m = env_get_float(kwargs, "blocked_corridor_min_half_width_m", 2.6f);
    env->blocked_corridor_max_half_width_m = env_get_float(kwargs, "blocked_corridor_max_half_width_m", 4.6f);
